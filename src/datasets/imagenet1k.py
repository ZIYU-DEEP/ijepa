...
def make_imagenet1k(transform: Optional[Callable]=None,
                    batch_size: int=128,
                    ...
                    image_folder: str='data/imagenet_1k/',
                    training: bool=False,
    ...
    dataset = ImageNet(root=root_path,
...
class ImageNet(torchvision.datasets.ImageFolder):
    ...
    def __init__(self,
        ...
        # [Unused] Copy data from an existing path
        data_path = None
        if copy_data:
        ...
        # Index the id of each labeled image
        if index_targets:
            self.targets = []
